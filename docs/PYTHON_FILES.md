...
| `portfolio_tracker/performance_metrics.py` | Calculates portfolio annualized IRR, simple return, and chained Modified Dietz time-weighted return by currency from runtime transaction, position, and valuation dataframes, including documented dynamic assumptions for incomplete transaction history. |
