...
| File | Purpose |
| --- | --- |
| `app.py` | Flask web server. Serves the Portfolio Tracker UI and Application Testing page, handles broker file uploads, runs the parser workflow and automated tests through API endpoints, and exposes generated output files. |
